 ...
 */
atk.image.imageDataToBuffer = function (imageData) {
    // remove alpha
 ...
 */
atk.image.getDefaultView = function (
    ...
    var image = new atk.image.Image( geometry, imageBuffer, numberOfFrames );
...
atk.image.getViewFromDOMImage = function (image)
{
    ...
    var imageBuffer = atk.image.imageDataToBuffer(imageData);
    var view = atk.image.getDefaultView(
 ...
 */
atk.image.getViewFromDOMVideo = function (video, callback, cbprogress, cbonloadend, dataIndex)
{
    // video size
    ...
    function storeFrame() {
        ...
        var imgBuffer = atk.image.imageDataToBuffer(
            ctx.getImageData(0, 0, width, height) );
        if (frameIndex === 0) {
            // create view
            view = atk.image.getDefaultView(
