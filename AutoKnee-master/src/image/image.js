 ...
 */
atk.image.Image = function(geometry, buffer, numberOfFrames)
{
...
atk.image.Image.prototype.quantifyLine = function(line)
{
    ...
    if (length !== null) {
        quant.length = {"value": length, "unit": atk.i18n("unit.mm")};
    }
    // return
    return quant;
};
...
atk.image.Image.prototype.quantifyRect = function(rect)
{
    ...
    var surface = rect.getWorldSurface( spacing.getColumnSpacing(),
            spacing.getRowSpacing());
    if (surface !== null) {
        quant.surface = {"value": surface/100, "unit": atk.i18n("unit.cm2")};
    }
    // stats
    var subBuffer = [];
