 ...
 */
atk.io.UrlsLoader.prototype.onload = function (/*event*/) {};
/**
 * Handle a load end event.
 * Default does nothing.
 */
atk.io.UrlsLoader.prototype.onloadend = function () {};
/**
 * Handle a progress event.
 * @param {Object} event The progress event.
 * Default does nothing.
 */
atk.io.UrlsLoader.prototype.onprogress = function (/*event*/) {};
/**
 ...
 * Default does nothing.
 */
atk.io.UrlsLoader.prototype.onerror = function (/*event*/) {};
 ...
 */
atk.io.UrlsLoader.prototype.load = function (ioArray, options)
{
    ...
    for (var i = 0; i < ioArray.length; ++i)
    {
        ...
        for (var l = 0; l < loaders.length; ++l) {
            ...
            if (loader.canLoadUrl(url)) {
                ...
                if (loader.loadUrlAs() === atk.io.urlContentTypes.ArrayBuffer) {
