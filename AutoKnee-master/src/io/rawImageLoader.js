 ...
 * Raw image loader.
 */
atk.io.RawImageLoader = function ()
{
    // closure to self
    var self = this;
    ...
    this.load = function ( dataUri, origin, index ) {
        ...
        image.onload = function (/*event*/) {
            try {
                self.onload( atk.image.getViewFromDOMImage(this) );
                self.onloadend();
            } catch (error) {
                self.onerror(error);
            }
 ...
 */
atk.io.RawImageLoader.prototype.canLoadFile = function (file) {
 ...
 */
atk.io.RawImageLoader.prototype.canLoadUrl = function (url) {
    var ext = url.split('.').pop().toLowerCase();
 ...
 */
atk.io.RawImageLoader.prototype.loadFileAs = function () {
 ...
 */
atk.io.RawImageLoader.prototype.loadUrlAs = function () {
 ...
 */
atk.io.RawImageLoader.prototype.onload = function (/*event*/) {};
/**
 * Handle an load end event.
 * Default does nothing.
 */
atk.io.RawImageLoader.prototype.onloadend = function () {};
/**
 ...
 * Default does nothing.
 */
atk.io.RawImageLoader.prototype.onerror = function (/*event*/) {};
/**
 * Handle a progress event.
 * @param {Object} event The progress event.
 * Default does nothing.
 */
atk.io.RawImageLoader.prototype.onprogress = function (/*event*/) {};

/**
 * Add to Loader list.
 */
atk.io.loaderList = atk.io.loaderList || [];
atk.io.loaderList.push( "RawImageLoader" );
