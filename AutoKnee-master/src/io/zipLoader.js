...
atk.io.ZipLoader = function ()
{
    ...
    function zipAsyncCallback(content)
    {
    	...
    	if (files.length < zobjs.length){
            ...
            var memoryIO = new atk.io.MemoryLoader();
 ...
 */
atk.io.ZipLoader.prototype.canLoadFile = function (file) {
 ...
 */
atk.io.ZipLoader.prototype.canLoadUrl = function (url) {
 ...
 */
atk.io.ZipLoader.prototype.loadFileAs = function () {
 ...
 */
atk.io.ZipLoader.prototype.loadUrlAs = function () {
 ...
 */
atk.io.ZipLoader.prototype.onload = function (/*event*/) {};
/**
 * Handle an load end event.
 * Default does nothing.
 */
atk.io.ZipLoader.prototype.onloadend = function () {};
/**
 ...
 * Default does nothing.
 */
atk.io.ZipLoader.prototype.onerror = function (/*event*/) {};
/**
 * Handle a progress event.
 * @param {Object} event The progress event.
 * Default does nothing.
 */
atk.io.ZipLoader.prototype.onprogress = function (/*event*/) {};

/**
 * Add to Loader list.
 */
atk.io.loaderList = atk.io.loaderList || [];
atk.io.loaderList.push( "ZipLoader" );
