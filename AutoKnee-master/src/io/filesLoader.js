 ...
 */
atk.io.FilesLoader.prototype.onload = function (/*event*/) {};
/**
 * Handle a load end event.
 * Default does nothing.
 */
atk.io.FilesLoader.prototype.onloadend = function () {};
/**
 * Handle a progress event.
 * @param {Object} event The progress event.
 * Default does nothing.
 */
atk.io.FilesLoader.prototype.onprogress = function (/*event*/) {};
/**
 ...
 * Default does nothing.
 */
atk.io.FilesLoader.prototype.onerror = function (/*event*/) {};
 ...
 * @external FileReader
 */
atk.io.FilesLoader.prototype.load = function (ioArray)
{
    ...
    var mproghandler = new atk.utils.MultiProgressHandler(self.onprogress);
    mproghandler.setNToLoad( ioArray.length );

    // get loaders
    var loaders = [];
    for (var m = 0; m < atk.io.loaderList.length; ++m) {
        loaders.push( new atk.io[atk.io.loaderList[m]]() );
    }
    ...
    for (var i = 0; i < ioArray.length; ++i)
    {
        ...
        for (var l = 0; l < loaders.length; ++l) {
            ...
            if (loader.canLoadFile(file)) {
                ...
                // read
                if (loader.loadFileAs() === atk.io.fileContentTypes.Text) {
                    reader.readAsText(file);
                } else if (loader.loadFileAs() === atk.io.fileContentTypes.DataURL) {
                    reader.readAsDataURL(file);
                } else if (loader.loadFileAs() === atk.io.fileContentTypes.ArrayBuffer) {
