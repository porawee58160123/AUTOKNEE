...
<!-- Launch the app -->
<script type="text/javascript" src="/atk/viewers/mobile/appgui.js"></script>
]])
...
<h1>atk <span class="atk-version"></span></h1>
...
<!-- Tags -->
<div id="atk-tags" title="Tags"></div>
</div><!-- /content -->
...
<div data-role="content">
<!-- Tags -->
<div id="atk-help" title="Help"></div>
</div><!-- /content -->
