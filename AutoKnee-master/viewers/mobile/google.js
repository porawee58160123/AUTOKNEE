 ...
 */
atk.google.getAuthorizedCallback = function (callback) {
 ...
 * @constructor
 */
atk.gui.GoogleDriveLoad = function (app)
{
    /**
    ...
    this.display = function (bool)
    {
        ...
        if (bool) {
            ...
            var gAuth = new atk.google.Auth();
            var gPicker = new atk.google.Picker();
            var gDrive = new atk.google.Drive();
            // pipeline
            gAuth.onload = gPicker.load;
            gPicker.onload = gDrive.loadIds;
            gDrive.onload = atk.google.getAuthorizedCallback(app.loadURLs);
            // launch
            gAuth.load();
        }
    };
